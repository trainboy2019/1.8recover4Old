...
public class TileEntityNetherBlock extends TileEntityLockable implements IUpdatePlayerListBox, IInventory
{
    /** List of effects that Beacon can apply */
    public static final Potion[][] effectsList = new Potion[][] {{Potion.absorption}, {Potion.damageBoost}, {Potion.digSpeed}, {Potion.fireResistance}, {Potion.healthBoost}, {Potion.jump}, {Potion.moveSpeed}, {Potion.nightVision}, {Potion.regeneration}, {Potion.resistance}, {Potion.saturation}, {Potion.waterBreathing}};
    ...
    private void func_146003_y()
    {
        ...
        TileEntityNetherBlock.BeamSegment beamsegment = new TileEntityNetherBlock.BeamSegment(EntitySheep.func_175513_a(EnumDyeColor.WHITE));
        ...
        for (i1 = k + 1; i1 < this.worldObj.getActualHeight(); ++i1)
        {
            ...
            {
                beamsegment = new TileEntityNetherBlock.BeamSegment(afloat);
                this.field_174909_f.add(beamsegment);
            }
    ...
    public net.minecraft.util.AxisAlignedBB getRenderBoundingBox()
    {
        ...
        else if (type != null && type != Blocks.beacon && type != BlockManager.netherBlock)
        {
    ...
    {
        return this.hasCustomName() ? this.customName : "container.netherBlock";
    }
    ...
    public boolean isNetherPayment(ItemStack stack)
    {
        Item item = null;
		return item == Items.emerald || item == Items.diamond || item == Items.gold_ingot || item == Items.iron_ingot || item == Items.quartz || item == ItemManager.americanIngot;
    }
    ...
    {
        return stack.getItem() != null && this.isNetherPayment(stack);
    }
