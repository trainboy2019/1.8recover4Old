...
public class CustomMob extends EntitySpider {
    ...
    public IEntityLivingData func_180482_a1(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_)
    {
       ...
       // if (this.worldObj.rand.nextInt(1) == 0)
        if (yt = true){
        {
        	CustomMob entityskeleton = new CustomMob(this.worldObj);
        ...
        {
            p_180482_2_1 = new CustomMob.GroupData();
        ...
        if (p_180482_2_1 instanceof CustomMob.GroupData)
        {
            int i = ((CustomMob.GroupData)p_180482_2_1).field_111105_a;
