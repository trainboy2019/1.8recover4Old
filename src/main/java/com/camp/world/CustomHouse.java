...
public class CustomHouse extends Village{
    ...
    public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        this.func_175804_a(worldIn, p_74875_3_, 0, 2, 1, 0, 4, 4, BlockManager.coloredWood.getStateFromMeta(4), BlockManager.coloredWood.getDefaultState(), false);
        this.func_175804_a(worldIn, p_74875_3_, 1, 2, 5, 7, 4, 5, BlockManager.coloredWood.getStateFromMeta(5), BlockManager.coloredWood.getDefaultState(), false);
        this.func_175804_a(worldIn, p_74875_3_, 8, 2, 1, 8, 4, 4, BlockManager.coloredWood.getStateFromMeta(11), BlockManager.coloredWood.getDefaultState(), false);
        this.func_175804_a(worldIn, p_74875_3_, 1, 2, 0, 7, 4, 0, BlockManager.coloredWood.getStateFromMeta(14), BlockManager.coloredWood.getDefaultState(), false);
        ...
        this.func_175804_a(worldIn, p_74875_3_, 1, 4, 1, 7, 4, 1, BlockManager.coloredWood.getStateFromMeta(4), BlockManager.coloredWood.getDefaultState(), false);
        this.func_175804_a(worldIn, p_74875_3_, 1, 4, 4, 7, 4, 4, BlockManager.coloredWood.getStateFromMeta(5), BlockManager.coloredWood.getDefaultState(), false);
        ...
        this.func_175811_a(worldIn, BlockManager.coloredWood.getStateFromMeta(11), 7, 1, 4, p_74875_3_);
        ...
        for (l = 0; l < 6; ++l)
        {
            for (int i1 = 0; i1 < 9; ++i1)
            {
                ...
                this.func_175808_b(worldIn, BlockManager.coloredWood.getStateFromMeta(14), i1, -1, l, p_74875_3_);
            }
        }
