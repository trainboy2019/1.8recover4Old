...
public class TileEntityNetherBlockRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation beaconBeam = new ResourceLocation(cm.MODID+":"+"textures/entity/nether_beam.png");
    private static final String __OBFID = "CL_00000962";

    /**
     * Renders the TileEntityBeacon, including the beam segments.
     */
    public void renderBeacon(TileEntityNetherBlock p_180536_1_, double p_180536_2_, double p_180536_4_, double p_180536_6_, float p_180536_8_, int p_180536_9_)
    {
        ...
        if (f1 > 0.0F)
        {
            ...
            {
            	TileEntityNetherBlock.BeamSegment beamsegment = (TileEntityNetherBlock.BeamSegment)list.get(k);
                ...
                GlStateManager.tryBlendFuncSeparate(771, 770, 1, 1);
                ...
                d11 = 0.0D;
                d12 = 1.0D;*/
                d3 = 0.2D;//SouthToNorthAStart
                d4 = 0.5D;//EastToWestAStart
                d5 = 0.5D;//SouthToNorthAEnd
                d6 = 0.2D;//EastToWestAEnd
                d7 = 0.5D;//SouthToNorthBStart
                d8 = 0.8D;//EastToWestBStart
                d9 = 0.8D;//SouthToNorthBEnd
                d10 = 0.5D;//EastToWestBEnd
                d11 = 0.0D;//TextureZoom
                d12 = 1.0D;
                d13 = (double)(-1.0F + f3);
            ...
            /*{
                ...
                double d14 = -1.0D;
                double d15 = (double)(-1.0F + f3);
                double d16 = ((double)((float)beamsegment.func_177264_c() * f1) * (0.5D / d4) + d15)*-1;
                worldrenderer.setColorRGBA_F(beamsegment.func_177263_b()[0], beamsegment.func_177263_b()[1], beamsegment.func_177263_b()[2], 0.125F);
                worldrenderer.addVertexWithUV(p_180536_2_ + d5, p_180536_4_ + (double)l, p_180536_6_ + d6, d14, d16);
                worldrenderer.addVertexWithUV(p_180536_2_ + d5, p_180536_4_ + (double)j, p_180536_6_ + d6, d14, d15);
                worldrenderer.addVertexWithUV(p_180536_2_ + d7, p_180536_4_ + (double)j, p_180536_6_ + d8, d13, d15);
    ...
    {
        this.renderBeacon((TileEntityNetherBlock)p_180535_1_, posX, posZ, p_180535_6_, p_180535_8_, p_180535_9_);
    }
}